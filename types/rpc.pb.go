...
var file_rpc_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0xc6, 0x1f, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x33, 0x33, 0x12, 0x2d, 0x0a,
	...
	0x12, 0x48, 0x0a, 0x10, 0x41, 0x64, 0x64, 0x50, 0x75, 0x73, 0x68, 0x53, 0x75, 0x62, 0x73, 0x63,
	0x72, 0x69, 0x62, 0x65, 0x12, 0x17, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x50, 0x75, 0x73,
	0x68, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x19, 0x2e,
	0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x53, 0x75, 0x62, 0x73, 0x63,
	0x72, 0x69, 0x62, 0x65, 0x50, 0x75, 0x73, 0x68, 0x22, 0x00, 0x42, 0x1f, 0x5a, 0x1d, 0x67, 0x69,
...
var file_rpc_proto_goTypes = []interface{}{
	...
	(*PushSubscribeReq)(nil),         // 51: types.PushSubscribeReq
	...
	(*ReplySubscribePush)(nil),       // 82: types.ReplySubscribePush
}
var file_rpc_proto_depIdxs = []int32{
	...
	51, // 72: types.chain33.AddPushSubscribe:input_type -> types.PushSubscribeReq
	9,  // 73: types.chain33.GetBlocks:output_type -> types.Reply
	52, // 74: types.chain33.GetLastHeader:output_type -> types.Header
	53, // 75: types.chain33.CreateRawTransaction:output_type -> types.UnsignTx
	53, // 76: types.chain33.CreateRawTxGroup:output_type -> types.UnsignTx
	54, // 77: types.chain33.QueryTransaction:output_type -> types.TransactionDetail
	...
	55, // 81: types.chain33.GetTransactionByAddr:output_type -> types.ReplyTxInfos
	56, // 82: types.chain33.GetTransactionByHashes:output_type -> types.TransactionDetails
	57, // 83: types.chain33.GetMemPool:output_type -> types.ReplyTxList
	58, // 84: types.chain33.GetAccounts:output_type -> types.WalletAccounts
	59, // 85: types.chain33.GetAccount:output_type -> types.WalletAccount
	59, // 86: types.chain33.NewAccount:output_type -> types.WalletAccount
	60, // 87: types.chain33.WalletTransactionList:output_type -> types.WalletTxDetails
	59, // 88: types.chain33.ImportPrivkey:output_type -> types.WalletAccount
	61, // 89: types.chain33.SendToAddress:output_type -> types.ReplyHash
	9,  // 90: types.chain33.SetTxFee:output_type -> types.Reply
	59, // 91: types.chain33.SetLabl:output_type -> types.WalletAccount
	62, // 92: types.chain33.MergeBalance:output_type -> types.ReplyHashes
	...
	57, // 96: types.chain33.GetLastMemPool:output_type -> types.ReplyTxList
	63, // 97: types.chain33.GetProperFee:output_type -> types.ReplyProperFee
	64, // 98: types.chain33.GetWalletStatus:output_type -> types.WalletStatus
	65, // 99: types.chain33.GetBlockOverview:output_type -> types.BlockOverview
	66, // 100: types.chain33.GetAddrOverview:output_type -> types.AddrOverview
	61, // 101: types.chain33.GetBlockHash:output_type -> types.ReplyHash
	67, // 102: types.chain33.GenSeed:output_type -> types.ReplySeed
	67, // 103: types.chain33.GetSeed:output_type -> types.ReplySeed
	9,  // 104: types.chain33.SaveSeed:output_type -> types.Reply
	68, // 105: types.chain33.GetBalance:output_type -> types.Accounts
	...
	53, // 109: types.chain33.CreateTransaction:output_type -> types.UnsignTx
	69, // 110: types.chain33.GetHexTxByHash:output_type -> types.HexTx
	70, // 111: types.chain33.DumpPrivkey:output_type -> types.ReplyString
	...
	71, // 114: types.chain33.Version:output_type -> types.VersionInfo
	9,  // 115: types.chain33.IsSync:output_type -> types.Reply
	72, // 116: types.chain33.GetPeerInfo:output_type -> types.PeerList
	73, // 117: types.chain33.NetInfo:output_type -> types.NodeNetInfo
	9,  // 118: types.chain33.IsNtpClockSync:output_type -> types.Reply
	74, // 119: types.chain33.GetFatalFailure:output_type -> types.Int32
	...
	75, // 122: types.chain33.GetBlockByHashes:output_type -> types.BlockDetails
	76, // 123: types.chain33.GetBlockBySeq:output_type -> types.BlockSeq
	9,  // 124: types.chain33.CloseQueue:output_type -> types.Reply
	77, // 125: types.chain33.GetAllExecBalance:output_type -> types.AllExecBalance
	78, // 126: types.chain33.SignRawTx:output_type -> types.ReplySignRawTx
	78, // 127: types.chain33.CreateNoBalanceTransaction:output_type -> types.ReplySignRawTx
	61, // 128: types.chain33.QueryRandNum:output_type -> types.ReplyHash
	41, // 129: types.chain33.GetFork:output_type -> types.Int64
	78, // 130: types.chain33.CreateNoBalanceTxs:output_type -> types.ReplySignRawTx
	79, // 131: types.chain33.GetParaTxByTitle:output_type -> types.ParaTxDetails
	80, // 132: types.chain33.LoadParaTxByTitle:output_type -> types.ReplyHeightByTitle
	79, // 133: types.chain33.GetParaTxByHeight:output_type -> types.ParaTxDetails
	81, // 134: types.chain33.GetHeaders:output_type -> types.Headers
	...
	70, // 138: types.chain33.GetWalletRecoverAddress:output_type -> types.ReplyString
	78, // 139: types.chain33.SignWalletRecoverTx:output_type -> types.ReplySignRawTx
	6,  // 140: types.chain33.GetChainConfig:output_type -> types.ChainConfigInfo
	82, // 141: types.chain33.AddPushSubscribe:output_type -> types.ReplySubscribePush
